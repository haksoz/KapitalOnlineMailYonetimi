                ...
                <div>
                    ...
                    <div class="mt-2 flex gap-4">
                        <label class="inline-flex items-center gap-2 cursor-pointer">
                            <input type="radio" name="currency" value="USD" class="currency-radio rounded-full border-gray-300 text-slate-600 focus:ring-slate-500" @checked(old('currency', 'USD') === 'USD')>
                            <span class="text-sm font-medium text-gray-700">USD (dolar)</span>
                        </label>
                        <label class="inline-flex items-center gap-2 cursor-pointer">
                            <input type="radio" name="currency" value="TRY" class="currency-radio rounded-full border-gray-300 text-slate-600 focus:ring-slate-500" @checked(old('currency') === 'TRY')>
                            <span class="text-sm font-medium text-gray-700">TL (sabit)</span>
                        </label>
                    </div>
                    <p class="mt-1 text-xs text-gray-500">Abonelik oluşturulurken bu para birimi kilitlenir. TL ürünlerde fiyat kurdan etkilenmez.</p>
                </div>
                {{-- Aylık Taahhütlü --}}
