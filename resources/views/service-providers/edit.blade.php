<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-2">
            <a href="{{ route('service-providers.index') }}" class="text-gray-500 hover:text-gray-700">&larr;</a>
            <h1 class="text-xl font-semibold text-gray-800">Servis Sağlayıcı Düzenle</h1>
        </div>
    </x-slot>
        ...
        <form action="{{ route('service-providers.update', $serviceProvider) }}" method="POST">
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <x-text-input id="code" name="code" type="text" class="mt-1 block w-full" :value="old('code', $serviceProvider->code)" />
                </div>
            </div>
