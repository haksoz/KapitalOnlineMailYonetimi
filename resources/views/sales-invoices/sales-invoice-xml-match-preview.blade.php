<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-2">
            <a href="{{ route('sales-invoices.sales-invoice-xml') }}" class="text-gray-500 hover:text-gray-700">&larr;</a>
            <h1 class="text-lg sm:text-xl font-semibold text-gray-800 truncate">Satış faturası XML — Eşleşen faturalar</h1>
        </div>
    </x-slot>
